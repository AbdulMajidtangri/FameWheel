      ...
      slide.innerHTML = `
        <div class="car-card-inner">
          ...
          <div class="car-details">
            ...
            <p class="car-price">${car.price}</p>
            <div class="car-location">
              <span> <i class="fa fa-map-marker"></i></span>${car.location}
            </div>
          </div>
        </div>
      `;
...
function Newcars(){
  ...
  <span> <i class="fa fa-map-marker"></i></span>${car.year}
</div>
            </div>
          </div>
        `;
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const carouselsConfig = [
      { carouselId: 'carousel2', indicatorsId: 'indicators2', counterSelector: '.counter2' },
      { carouselId: 'carousel3', indicatorsId: 'indicators', counterSelector: '.counter' },
    ];
  ...
  function NewLaunchcars(){
    ...
    document.addEventListener('DOMContentLoaded', () => {
      const carouselsConfig = [
        { carouselId: 'carousel3', indicatorsId: 'indicators3', counterSelector: '.counter3' },
      ];
...
function animateInspection(){
  // Add another animation for h1 to come from below (y-axis)
gsap.from(".content h1", {
  y: 130, 
  opacity: 0,
  duration: 1,
  scrollTrigger: {
      trigger: ".inspection-section",
      start: "top 100%", 
      scrub: true,
      toggleActions: "play none none none"
  }
});
//aniamte the p apearing from y-axis
gsap.from(".content p", {
  y: 130, 
  opacity: 0,
  duration: 1,
...
// Animate the button appearing from below (y-axis)
